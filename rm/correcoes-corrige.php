                            ...
                            <div class="contain-card p-4 block-md lista">
                                ...
                                foreach($corrige as $item ):  ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <small class="form-text text-muted"><strong>Coleta <?php echo $item->coletaID ?> - Realizada pelo Coletor #<?php echo $item->coletorID ?> <?php echo $item->coletorNome ?>.</strong></small>
